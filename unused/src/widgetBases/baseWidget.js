            ...
            attach: {
                value: function (node) {
                    return q.Promise(function (resolve, reject) {
                        ...
                        q(this.onAttachWrapper(this.container))
                            .then(function () {
                                this.placeContent();
                                q.all(this.getWidgets().map(function (w) {
