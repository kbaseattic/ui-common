/*
  ...
  Shock javascript client library [UPDATED by nconrad, 8/11/2014]

  **UPDATES**
  use jquery.ajax instead of getJSON for authentication header
...
(function () {
	...
	//var promise = jQuery.Deferred();
    var promise = jQuery.ajax({ url: url,
	    success: function(data) {
		var retval = null;
		if (data != null && data.hasOwnProperty('data')) {
		    if (data.error != null) {
