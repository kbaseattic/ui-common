...
app.service('modals', function() {
    ...
    this.createWS = function(params) {
        ...
        var createModal = kbasePrompt($('<div>'), {
    ...
    /*
    var modal = kbaseModal($('<div>'), {title: 'Create Workspace',
                                       body: body,
                                       buttons: [{text: 'Cancel'},
    ...
    */
    ...
    this.copyWS = function(params) {
        ...
        var copyWSModal = kbasePrompt($('<div>'), {
    ...
    this.deleteWS = function(params) {
        ...
        var deleteModal = kbasePrompt($('<div>'), {
    ...
    this.manageWS = function(params) {
        ...
        var permData;
        var manage_modal = kbasePrompt($('<div>'), {
