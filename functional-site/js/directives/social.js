...
.directive('socialappoverview', function($rootScope) {
    return {
	    ...
	    // setup panel
            var p = $(ele).kbasePanel({title: appid}) /* ,rightLabel: "ws", subText: scope.userid}); */
            p.loading();
...
.directive('socialappreviews', function($rootScope) {
    return {
	    ...
	    // setup panel
            var p = $(ele).kbasePanel({title: "Reviews"}) /* ,rightLabel: "ws", subText: scope.userid}); */
            p.loading();
...
.directive('socialappusagestats', function($rootScope) {
    return {
	    ...
	    // setup panel
            var p = $(ele).kbasePanel({title: "Usage Stats"}) /* ,rightLabel: "ws", subText: scope.userid}); */
            p.loading();
