        ...
        var factory = function () {
            ...
            */
            ...
            function renderAvatar() {
                ...
                return img({src: '/modules/navbar/images/nouserpic.png', style: 'width: 40px;', class: 'login-button-avatar', 'data-element': 'avatar'});
            }
                ...
                var content = div({class: 'container-fluid'}, [
                    div({class: 'navbar-header navbar-menu'}, [
                        ...
                        a({href: 'http://kbase.us'}, [
                            img({id: 'logo', src: 'modules/navbar/images/kbase_logo.png', width: '46'})
                        ])
                    ]),
