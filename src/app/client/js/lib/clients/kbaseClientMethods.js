define([
    ...
    function (Promise, R, Utils, APIUtils, Workspace, UserProfile, NarrativeMethodStore) {
        ...
        return Object.create({}, {
            ...
            getApps: {
                value: function () {
                    return Promise.resolve(this.narrativeMethodStoreClient.list_apps({}));
                }
            },
            getMethods: {
                value: function () {
                    return Promise.resolve(this.narrativeMethodStoreClient.list_methods({}));
                }
            },
            getCollaborators: {
                            ...
                            .then(function (narratives) {
                                this.getPermissions(narratives)
                                    .then(function (narratives) {
                                        ...
                                        Promise.resolve(this.userProfileClient.get_user_profile(usersToFetch))
                                            .then(function (data) {
                                                try {
                                                    for (var i = 0; i < data.length; i++) {
