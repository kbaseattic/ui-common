define(['kb.widget.social.base', 'kb.service.user_profile', 'kb.session', 'kb.utils'],
   function (SocialWidget, UserProfileService, Session, Utils) {
      "use strict";
               ...
               if (Session.isLoggedIn()) {
                  ...
                  this.container.find('[data-field="search_text"] input').on('keyup', function (e) {
                     ...
                     if (widget.params.searchText && widget.params.searchText.length < 3) {
                        ...
                        Utils.promise(widget.userProfileClient, 'filter_users', {
