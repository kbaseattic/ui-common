...
define([
    ...
    // ultra crude, which means it saves from rewriting this widget
    // just add all the widgets that MIGHT be loaded here...
    'kb.jquery.contigset',
    'kb.jquery.spec.type-card',
    'kb.jquery.landing-page-card'
],
    function ($, Q, R, Workspace, FBA) {
        'use strict';
        $.KBWidget({
            ...
            cdmWorkspace: "CDS",
            defaultWidth: 300,
            fbaURL: R.getConfig('service.fba.url'),
            ...
            init: function (options) {
                ...
                this.fbaClient = new FBA(this.fbaURL);
            ...
            makeDataManager: function () {
                ...
                var $buttonPanel = $("<div/>")
                    ...
                    .append($("<button/>")
                        .on("click", function (event) {
                            self.toggleSelectAll($(event.currentTarget));
                        })
            ...
            exportToWorkspace: function () {
                ...
                if (this.options.auth === null || this.options.userId === null) {
                    ...
                    this.exportModal.okButton.click(function (event) {
                        doExport();
                    });
            ...
            addNewCard: function (cardName, options, position) {
                ...
                console.log('about to access card');
