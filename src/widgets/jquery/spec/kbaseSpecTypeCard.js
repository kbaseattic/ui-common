...
define([
    ...
    function ($, R, Workspace, specCommon, PR) {
        'use strict';
        $.KBWidget({
            ...
            init: function (options) {
                ...
                var self = this;
                var pref = specCommon.generateSpecPrefix();
                var container = self.$elem;
                container.append('<p class="muted loader-table"><img src="assets/img/ajax-loader.gif"> loading...</p>');

                var kbws = new Workspace(R.getConfig('service.workspace.url'), {token: self.options.token});
                ...
                kbws.get_type_info(this.options.id, function (data) {
                    ...
                    var tabNames = ['Overview', 'Spec-file', 'Functions', 'Using Types', 'Sub-types', 'Versions'],
                        tabIds = ['overview', 'spec', 'funcs', 'types', 'subs', 'vers'],
                    ...
                    /* TODO: fix this
                    specClicks[pref + 'modver-click']r = (function (elem, e) {
                    ...
                    */
                    ...
                    specText = specCommon.replaceMarkedTypeLinksInSpec(moduleName, specText, pref + 'links-click');
                    $('#' + pref + 'spec').append(
