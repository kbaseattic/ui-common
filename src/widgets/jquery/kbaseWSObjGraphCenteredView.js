...
/*jslint
    ...
    white: true
*/
define(['jquery', 'd3', 'd3-sankey', 'css!d3-sankey-css', 'kb.jquery.authenticatedwidget'], function ($, d3) {
    'use strict';
    $.KBWidget({
        ...
        init: function (options) {
            ...
            if (self.options.ws_url) {
                self.wsUrl = self.options.ws_url;
            }
            if (self.options.token) {
                self.ws = new Workspace(self.wsUrl, {token: self.options.token});
            } else {
