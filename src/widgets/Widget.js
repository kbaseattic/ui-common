        ...
        var Widget = Object.create({}, {
            ...
            Widget_init: {
                value: function (cfg) {
                    ...
                    this.templates = {};
                    var loaders = [
                        new nunjucks.WebLoader('/src/widgets/' + this.widgetName + '/templates', true)
                    ];
                    ...
                    this.templates.env.addFilter('titleLabel', function (title) {
                        if (this.listMapsuserTitles[title]) {
                            return this.userTitles[title].label;
                        }
                        return title;
                    }.bind(this));
                    this.templates.env.addFilter('permissionLabel', function (permissionFlag) {
                        if (this.permissionFlags[permissionFlag]) {
                            return this.permissionFlags[permissionFlag].label;
                        }
