...
//            
    ...
    */
    var introTemplate = (function () {
        ...
        s += '---\n';
        s += '\n';
        s += 'Design and carry out collaborative computational experiments while creating Narratives: interactive, shareable, and reproducible records of your data, computational steps, and thought processes.\n';
        s += '\n';
        ...
        s += '---\n';
        s += '\n';
        s += 'Click the Add Data button in the Data Panel to browse for KBase data or upload your own. Mouse over a data object to add it to your Narrative, and check out more details once the data appears in your list.\n';
        s += '\n';
        ...
        s += '---\n';
        s += '\n';
        s += 'Browse available analyses that can be run using KBase apps or methods (apps are just multi-step methods that make some common analyses more convenient). Select an analysis, fill in the fields, and click Run. Output will be generated, and new data objects will be created and added to your data list. Add to your results by running follow-on apps or methods.\n';
        s += '\n';
        ...
        s += '---\n';
        s += '\n';
        s += 'Be sure to save your Narrative frequently. When you\'re ready, click the share button above to let collaborators view your analysis steps and results. Or better yet, make your Narrative public and help expand the social web that KBase is building to make systems biology research open, collaborative, and more effective.\n';
        s += '\n';
        ...
        s += '---\n';
        s += '\n';
        s += 'For more information, please see the <a href="<%= docBaseUrl %>/narrative-guide">Narrative Interface User Guide</a> or the <a href="<%= docBaseUrl %>/tutorials">app/method tutorials</a>.\n';
        s += '\n';
        s += 'Questions? <a href="<%= docBaseUrl %>/contact-us">Contact us</a>!\n';
        s += '\n';
        s += 'Ready to begin adding to your Narrative? You can keep this Welcome cell or delete it with the trash icon in the top right corner.';
        return s;
    }());
