function KBase_FBAModel(modeltabs) {
    ...
    this.set_metadata = function (indata) {
        ...
        // I don't see these in the user metadata
        /*
         {name: indata[10]["Name"],
         source: indata[10]["Source"]+"/"+indata[10]["Source ID"],
         genome: indata[10]["Genome"],
         modeltype: indata[10]["Type"],
         numreactions: indata[10]["Number reactions"],
         numcompounds: indata[10]["Number compounds"],
         numcompartments: indata[10]["Number compartments"],
         numbiomass: indata[10]["Number biomasses"],
         numgapfills: indata[10]["Number gapfills"]}
        */
    };
