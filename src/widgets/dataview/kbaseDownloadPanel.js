...
(function( $, undefined ) {
    $.KBWidget({
        ...
        init: function(options) {
            ...
            this.shockURL = kb.urls.shock;
            this.exportURL = kb.urls.data_import_export;
            this.token = kb.token;
            this.type = null; //this.options.type;
            this.wsId = this.options.params.ws;
            this.objId = this.options.params.obj;
            var self = this;
            kb.ws.get_object_info_new({objects:[{ref:this.wsId+"/"+this.objId}]}, function(objInfoList) {
        ...
        render: function() {
            ...
            downloadPanel.css({'min-width': '260px', 'margin-left': '10px'});
