...
require.config({
  ...
  paths: {
      ...
      // modeling
      'kb.widget.dataview.modeling.objects': 'src/widgets/jquery/modeling/KBObjects',
      'kb.widget.dataview.modeling.biochem-media': 'src/widgets/jquery/modeling/KBaseBiochem.Media',
      'kb.widget.dataview.modeling.fba': 'src/widgets/jquery/modeling/KBaseFBA.FBA',
      'kb.widget.dataview.modeling.fba-model': 'src/widgets/jquery/modeling/KBaseFBA.FBAModel',
      'kb.widget.dataview.modeling.fba-model-set': 'src/widgets/jquery/modeling/KBaseFBA.FBAModelSet',
      'kb.widget.dataview.modeling.phenotype-set': 'src/widgets/jquery/modeling/KBasePhenotypes.PhenotypeSet',
      'kb.widget.dataview.modeling.phenotype-simulation-set': 'src/widgets/jquery/modeling/KBasePhenotypes.PhenotypeSimulationSet',
      'kb.widget.dataview.modeling.genome-set': 'src/widgets/jquery/modeling/KBaseSearch.GenomeSet',
      'kb.widget.dataview.modeling.tab-table': 'src/widgets/jquery/modeling/kbaseTabTable',
      // trees
